...
public:
    ...
    friend constexpr std::strong_ordering operator<=>(const IntBitSet& a, const IntBitSet& b) noexcept = default;
...
public:
    ...
    /** Compare two bitsets lexicographically. */
    friend constexpr std::strong_ordering operator<=>(const MultiIntBitSet& a, const MultiIntBitSet& b) noexcept = default;
    /** Swap two bitsets. */
