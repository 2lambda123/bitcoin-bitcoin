...
bool GenerateAuthCookie(std::string* cookie_out, CookiePerms::Perm cookie_perms)
{
    ...
    std::error_code code;
    fs::permissions(filepath, cookie_perms.permissions, fs::perm_options::replace, code);
    if (code) {
